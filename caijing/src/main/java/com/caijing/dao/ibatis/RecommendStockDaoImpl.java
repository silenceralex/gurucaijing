...
public class RecommendStockDaoImpl extends CrudDaoDefault implements RecommendStockDao {
	...
	public Integer getRecommendStocksCountByStockcode(String stockcode) {
		...
		return (Integer) getSqlMapClientTemplate().queryForObject(
				this.getNameSpace() + ".getRecommendStocksCountByStockcode", params);
	}
	...
	public Integer getRecommendStocksCountByStockname(String stockname) {
		...
		params.put("stockname", stockname);
		return (Integer) getSqlMapClientTemplate().queryForObject(
				this.getNameSpace() + ".getRecommendStocksCountByStockname", params);
	}
	...
	public void updateObjectPriceByReportid(String id, float objectprice) {
		Map<String, Object> params = new HashMap<String, Object>(4);
		params.put("recommendid", id);
		params.put("objectprice", objectprice);

		getSqlMapClientTemplate().update(this.getNameSpace() + ".updateObjectPriceByReportid", params);
	...
	public List<RecommendStock> getStocksByAidAndStock(String aid, String stockcode, int length) {
		...
		params.put("length", length);
		params.put("aid", aid);
		return (List<RecommendStock>) getSqlMapClientTemplate().queryForList(
