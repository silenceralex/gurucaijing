...
public class FetchRecommendStock {
	...
	ReportExtractorImpl extractor = (ReportExtractorImpl) context
...
//				rs.setStockname(name);
	...
	public void extractAfter(String saname, String date) {
		...
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("申银万国", "2010-09-15
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("国泰君安", "2010-09-15
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("中金公司", "2010-09-15
		// 00:00:00");
		// List<Report> reports =
		...
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("安信证券", "2010-09-15
		// 00:00:00");
	...
	public static void main(String[] args) {
		...
		fetch.process();
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("申银万国", "2010-09-13
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("国泰君安", "2010-09-13
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("中金公司", "2010-09-13
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("海通证券", "2010-09-13
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("国金证券", "2010-09-13
		// 00:00:00");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("安信证券", "2010-09-13
//		// 00:00:00");
//		List<Report> reports = reportDao.getCompanyReportsBySanameAfter("国金证券",
//				"2010-09-13 00:00:00");
		// List<Report> reports = reportDao.getCompanyReportsBySaname("广发证券");
		// List<Report> reports =
		// reportDao.getCompanyReportsBySanameAfter("广发证券", "2010-09-15
		// 00:00:00");
//		System.out.println("Reports size: " + reports.size());
		long end = System.currentTimeMillis();
		System.out.println("Use time: " + (end - start) / 1000 + " seconds");
