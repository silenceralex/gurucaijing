...
public class UserManagerTest extends TestCase {
	private String temporaryUsername = "test";
	private long temporaryUid = 10;
	...
	protected void setUp() throws Exception {
		...
		String insertSql = "insert into user (uid,username,password,nickname,birthday,introduction,default_setting,reg_time,credit) values ("
				...
				+ ",'"
				+ temporaryUsername
				+ "',md5('test163@'),'raynick','1973-09-30','n/a','kick',now(),10)";
	...
	public void testLogin() {
		String correctPassword = "test163@", wrongPassword = "abcdef";
		try {
